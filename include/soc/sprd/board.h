...
#define SPRD_ION_BASE_USE_VARIABLE
#ifndef SPRD_ION_BASE_USE_VARIABLE
#if defined(CONFIG_MACH_SP7715GA) || defined(CONFIG_MACH_SP7715GATRISIM) || defined(CONFIG_MACH_SP8815GA) || defined(CONFIG_MACH_SP8815GAOPENPHONE) || defined(CONFIG_MACH_SP6815GA) || defined(CONFIG_MACH_SP7731GEA_LC) || defined(CONFIG_MACH_SP7731GGA_LC) || defined(CONFIG_MACH_SP7731GGA) || defined(CONFIG_MACH_SP7730GGA_LC)/* Nand 4+2 */
#define SPRD_ION_MEM_BASE	\
	((CONFIG_PHYS_OFFSET & (~(SZ_256M - 1))) + SZ_256M - SPRD_ION_MEM_SIZE)
#else
#define SPRD_ION_MEM_BASE	\
...
#endif
#else
#if defined CONFIG_MACH_SP7731GEA_HD || defined CONFIG_MACH_SP7731GEPIKE || defined CONFIG_MACH_SP7731GEA_HD2 || defined CONFIG_MACH_SP7731GEA_QHD
#define SPRD_ION_MEM_BASE	\
